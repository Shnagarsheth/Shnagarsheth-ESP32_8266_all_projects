...
// Class Atributes
#define AFECS 5             // Chip Select ADE7758 - Es el pin al que se conecta el AFE, luego le sumo 8 para compatibilizar con digitalwrite  
#define WRITE 0x80          // WRITE bit BT7 to write to registers
#define CLKIN 12000000      // ADE7758 frec, 12.000000MHz
...
#define PEAKSEL1	0x04
#define PEAKSEL2	0x08
#define PEAKSEL3	0x10

#define PKIRQSEL1	0x20
#define PKIRQSEL2	0x40
#define PKIRQSEL3	0x80
#define PKIRQSELALL	0xE0
...
long getWFORM(); //Adding public -- Configuration for WAVE MODE
void setPVoltageDetect(char pvalue);
void setPCurrentDetect(float pvalue);
void setSVoltageDetect(char lvalue);
