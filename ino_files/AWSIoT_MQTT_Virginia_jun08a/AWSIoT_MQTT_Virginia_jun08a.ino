...
//Stabilizer Data
int entryNo = 1, Vin = 245, Vout = 230, Ie = 0, Ve = 0; 
String clientname = "Nitech_1";
float Current = 4.0;
byte mac[6];
char mac_Id[18];
...
const char* awsEndpoint = "*****************";    //Your AWSEndpoint
...
void loop() {
  ...
  sprintf(fakeData, "{\"stabilizerID\":\"%s\", \"clientName\":\"%s\", \"no\":%d, \"time\":\"%s\", \"date\":\"%s\", \"vin\":%d, \"vout\": %d, \"current\": %f, \"earthLeakageCurrent\": %d, \"phaseEarthVoltage\": %d}", mac_Id, clientname, entryNo, timeStamp, dayStamp, Vin, Vout, Current, Ie, Ve);
 /*
