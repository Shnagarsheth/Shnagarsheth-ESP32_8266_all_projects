...
void setup() {
 ...
 // You can remove the password parameter if you want the AP to be open.
  WiFi.softAP(ssid, password, 1, ssid_hidden , 1);
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf("GET /TE/data") >= 0) {
...
//            } 
               ...
               client.print("<p><a href=\"/2/on\"><button class=\"button\">ON</button></a></p>");
               client.print("<p><a href=\"/2/off\"><button class=\"button button2\">OFF</button></a></p>");
    ...
    //client.print('A');
    client.stop();
    Serial.println("Client disconnected123SH.");
    Serial.println("");
  } 
}
