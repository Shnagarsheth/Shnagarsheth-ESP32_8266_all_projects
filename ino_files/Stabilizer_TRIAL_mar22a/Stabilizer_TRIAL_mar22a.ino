...
void setup() {
 ...
 //wifiManager.setAPStaticIPConfig(IPAddress(1,2,3,4), IPAddress(1,2,3,1), IPAddress(255,255,255,0));
  wifiManager.setSTAStaticIPConfig(ip,gateway,subnet,staticDNS);
